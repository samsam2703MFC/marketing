...
final class CampaignController
{
    ...
    public function store(Request $request): array
    {
        ...
        $payload = $request->only([
            ...
            'image_url', 'focal_point_y', 'image_fit', 'shop_ids', 'shop_targets', 'channels', 'lever_targets',
    ...
    public function replace(Request $request): array
    {
        ...
        $payload = $request->only([
            ...
            'agency_note', 'b2b_webshop_enabled', 'pos_survey_enabled', 'pos_questions',
            'create_crm_leads', 'image_url', 'focal_point_y', 'image_fit', 'shop_ids', 'shop_targets', 'channels',
